(function($){
    ...
    var Lang = {
        ru: {
            ...
            maxPurchase: 'Больше всего заказов (_COUNT_) было _DATE_ _MONTH_ 2016 года.',
        ...
        sk: {
            //Месяца
            months: [ 'Január', 'Február', 'Marec', 'Apríl', 'Máj', 'Jún', 'Júl', 'August', 'Septembra', 'Október', 'November', 'December'],
            //Месяца в родительcком падеже
            monthsRp: [ 'január', 'február', 'marec', 'apríl', 'máj', 'jún', 'júl', 'august', 'septembra', 'október', 'november', 'december'],
            //Месяца в предложном падеже
            monthsPp: ['januári', 'februári', 'marci', 'apríli', 'máji', 'júni', 'júli', 'auguste', 'septembri', 'októbri', 'novembri', 'decembri'],
            maxPurchase: 'Najvyšší počet objednávok (_COUNT_) bol zadaný v _DATE_ _MONTH_  ',
            stockInfoTitle: 'Zľava viac než 100 000 v',
            stockInfoTime: 'Zľava začína _STARTDATE_ _STARTMONTH_ a končí  _ENDDATE_ _ENDMONTH_'
        }
    };
